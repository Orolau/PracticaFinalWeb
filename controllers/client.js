...
const restoreClient = async (req, res) => {
    try {
      ...
      res.status(200).send({ message: 'Client restored successfully' });
    } catch (err) {
      handleHttpError(res, 'INTERNAL_SERVER_ERROR', 500);
    }
  };
...
module.exports = {
    createClient, updateClient, getClients, getClientById,
    deleteClient, archiveClient, getArchivedClients, restoreClient
}